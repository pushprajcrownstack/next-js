                        ...
                        <form className="space-y-6" onSubmit={handleSubmit(submitForm)}>
                            <div>
                                ...
                                <div className="mt-2">
                                    ...
                                    />
                                    {errors.username && <span role="alert" className='text-red-600'>{errors.username?.message}</span>}
                            ...
                            <div>
                                ...
                                <div className="mt-2">
                                    <input
                                        {...register('confimPassword', { required: "Re enter your password" })}
                                        id="confimPassword"
                                        name="confimPassword"
                                        type="confimPassword"
                                        ...
                                        className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                                    />
                                    {errors.confimPassword && <span role="alert" className='text-red-600'>{errors.confimPassword?.message}</span>}
